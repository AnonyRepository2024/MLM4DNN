...
2. Benchmark preparation
    * Refer to [benchmark/README.md](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/benchmark/README.md) to get our benchmark (i.e., $Benchmark_{51}$ and $Benchmark_{38}$)

3. Dataset preparation
    * Refer to [dataset/README.md](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/dataset/README.md) to get our dataset (i.e., $Dataset_{MLM}$)

4. Model preparation
    * Refer to [models/README.md](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/models/README.md) to get our fine-tuned model
...
5. Main [conda](https://www.anaconda.com/) env preparation (for component 1,2,3)
    ...
    * Install libraries for this env
        ...
        * requests 2.31.0
        * tqdm 4.66.1
    * See [mlm4dnn_main_env.yml](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/mlm4dnn_main_env.yml) for details
...
6. PV [conda](https://www.anaconda.com/) env preparation (for component 4)
    ...
    * Install libraries for this env
        ...
        * scikit-learn 0.23.1
        * astunparse 1.6.3
    * See [mlm4dnn_pv_env.yml](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/mlm4dnn_pv_env.yml) for details
...
2. MLM4DNN Performing
    * Create a config file (refer to [configs/infill_api_config.json](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/configs/infill_api_config.json))
...
* Complete [Table-3](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/appendix/table3.xlsx) that shows results of RQ1 in our paper
* The [outputs](https://github.com/AnonyRepository2024/MLM4DNN/blob/main/appendix/deepdiagnosis_outputs.xlsx) of [DeepDiagnosis](https://github.com/DeepDiagnosis/ICSE2022) on our two benchmarks
