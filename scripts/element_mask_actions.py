...
class KerasCompileUnsuitableAccuracyMetric(MaskAction):
...
class KerasCompileUnsuitableLearningRate(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasCompileUnsuitableOptimizer(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasCompileWrongLoss(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasFitUnsuitableEpochs(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasFitUnsuitableTrainBatchSize(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasLayerUnsuitableActivation(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
class KerasLayerUnsuitableInitializer(MaskAction):
    def generate_masked_models(self, code: str) -> list[str, str]:
        result = []
        codeast = ast.parse(code)
        # L1 Template
...
def get_all_actions() -> list[MaskAction]:
    return sorted(
        [
            KerasCompileUnsuitableAccuracyMetric(),
            KerasCompileUnsuitableLearningRate(),
            KerasCompileUnsuitableOptimizer(),
            KerasCompileWrongLoss(),
            KerasFitUnsuitableEpochs(),
            KerasFitUnsuitableTrainBatchSize(),
            KerasLayer(),
            KerasLayerUnsuitableActivation(),
            KerasLayerUnsuitableInitializer(),
        ],
